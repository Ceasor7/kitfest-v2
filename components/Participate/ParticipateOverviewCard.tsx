...
import { LuDrum, LuHandshake } from "react-icons/lu";
import { FaChalkboardUser } from "react-icons/fa6";
import { MdOutlineVolunteerActivism } from "react-icons/md";
import { BsShopWindow } from "react-icons/bs";
import { LiaUsersSolid } from "react-icons/lia";

interface ParticipateOverviewCardProps {
  iconName:
    | "LuDrum"
    | "LuHandshake"
    | "FaChalkboardUser"
...
const iconMap: Record<ParticipateOverviewCardProps["iconName"], IconType> = {
  LuDrum: LuDrum,
  LuHandshake: LuHandshake,
  FaChalkboardUser: FaChalkboardUser,
  MdOutlineVolunteerActivism: MdOutlineVolunteerActivism,
  BsShopWindow: BsShopWindow,
  LiaUsersSolid: LiaUsersSolid,
};

const ParticipateOverviewCard: FC<ParticipateOverviewCardProps> = ({
  iconName,
  iconBgColor,
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="text-lg font-semibold text-center mt-7">{title}</h3>

      {/* Description */}
      <p className="text-sm text-center mt-2 mb-10">{description}</p>
...
export default ParticipateOverviewCard;
