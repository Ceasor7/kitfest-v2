    ...
    >
      ...
      <div className="w-full lg:w-2/3 bg-gray-200 p-6 rounded-2xl lg:rounded-b-none lg:rounded-r-xl flex flex-col justify-center">
        ...
        <p className=" mb-4">
          ...
          this transformative journey will take you on a mesmerizing exploration
          of Heightened Language, Dance, and Contact Improvisation. Join us as
          we delve into the depths of collaborative creation, weaving together
          the diverse artistry of actors, dancers, poets, and visual artists.
          Inspired by community-relevant themes, folklore, and poetry, we will
          collectively craft a groundbreaking new work that resonates with the
          soul of our society. Immerse yourself in a week-long intensive
          workshop from May 17th to 21st, where creativity knows no bounds, and
          boundaries blur as we embrace the power of devised performance.
          <br />
          The application Closes 15th May 2023. Feedback shall be given on 16th
          May.
          <br />
          Success in your Application
        </p>
        <button className="bg-[#FF6F00] text-white px-4 py-2 rounded-full hover:bg-[#FF6F00]/80 transition-colors w-fit">
          Learn More
        </button>
      </div>
    </motion.div>
