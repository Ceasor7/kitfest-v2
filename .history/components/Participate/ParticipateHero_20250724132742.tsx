  ...
  return (
    <div>
      <div className="bg-[#FFD0A0]/30">
        <div className="max-w-6xl mx-auto px-4 py-7 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="max-w-[500px]">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-3xl md:text-5xl max-w-[250px] leading-relaxed font-['Bona_Nova'] italic text-center mb-4 text-[#860000]"
              >
