...
import Logo from "./Logo"; // Adjust path based on your structure
...
const FloatingNavbar: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: "Blog", href: "/blog", icon: <User size={16} /> },
        {
          label: "Tickets",
          href: "/tickets",
          icon: <Mail size={16} />,
  ...
  return (
    ...
    >
      <div className="rounded-3xl shadow-lg border border-border bg-[#0E121B] px-6 py-3">
                  ...
                  <AnimatePresence>
                    {openDropdown === item.label && (
                      <motion.div
                        ...
                        className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-48 bg-[#0E121B] border border-border rounded-lg shadow-lg py-2 z-50"
                        role="menu"
                        onMouseEnter={() => {
