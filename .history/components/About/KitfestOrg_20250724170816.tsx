          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Button className="bg-[#FF6F00] text-background hover:bg-[#FF6F00]/90 rounded-full px-12 py-4 font-medium transition-all duration-300 hover:scale-105">
                  Learn More
                </Button>
              </motion.div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/2">
              ...
              >
                The Kenya Cultural Centre, incorporating the Kenya National
                Theatre, stands as the premier cultural institution in Kenya. It
                serves as the heartbeat of the nation's artistic expression,
                providing a world-class venue for theatrical performances,
                cultural events, and artistic education that celebrates Kenya's
            ...
            <div className="w-full lg:w-1/2">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Button className="bg-[#FF6F00] text-background hover:bg-[#FF6F00]/90 rounded-full px-8 py-3 font-medium transition-all duration-300 hover:scale-105">
                  Learn More
                </Button>
              </motion.div>
            </div>
